...
i386-elf-ld -o "Binaries/full_kernel.bin" -Ttext 0x1000 "Binaries/kernel_entry.o" "Binaries/kernel.o" "Binaries/keyboardUtils.o" "Binaries/VGA.o" "Binaries/Util.o" "Binaries/Pong.o" --oformat binary

cat "Binaries/boot.bin" "Binaries/full_kernel.bin" "Binaries/zeroes.bin"  > "Binaries/OS.bin"

qemu-system-i386 -drive format=raw,file="Binaries/OS.bin",index=0,if=floppy, -m 128M
